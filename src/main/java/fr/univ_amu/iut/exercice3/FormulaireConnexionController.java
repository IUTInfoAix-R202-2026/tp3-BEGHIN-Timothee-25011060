...
public class FormulaireConnexionController {
  ...
  private void initialize() {
    ...
    BooleanBinding motDePasseInvalide =
        new BooleanBinding() {
          {
            super.bind(champMotDePasse.textProperty(), champIdentifiant.textProperty());
          }
  ...
  private void valider() {
    ...
    String astérisques = "*".repeat(motDePasse.length());
    labelMessage.setText(identifiant + " " + astérisques);
  }
